"""Task 01 configuration models and YAML loading helpers."""
...
DEFAULT_CONFIG_PATH = TASK01_ROOT / "configs" / "knapsack_default.yaml"
...
def load_experiment_config(config_path: str | Path = DEFAULT_CONFIG_PATH) -> LoadedExperimentConfig:
    """Load and validate the task01 experiment config from a YAML file."""
